...
export default function Movies() {
  ...
  const { data: moviesData, isLoading, fetchNextPage, isFetchingNextPage, hasNextPage } = useQuery({
    queryKey: ['/api/discover/movie', selectedGenre, year, currentPage],
    queryFn: () => discoverMovies(selectedGenre || undefined, year || undefined, currentPage),
      ...
      <div className="container mx-auto px-4">
        ...
        {isLoading && currentPage === 1 ? (
          ...
          <div className="bg-dark-300 rounded-xl p-6 text-center">
            ...
            <p className="text-lg font-poppins mb-2">Aucun film trouvé</p>
